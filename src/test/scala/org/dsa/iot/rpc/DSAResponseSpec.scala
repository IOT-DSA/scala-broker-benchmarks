 ...
 */
class DSAResponseSpec extends AbstractSpec {
  import DSAValue._
  ...
  "DSAError" should {
    ...
    "serialize to JSON with optional fields present" in testJson(
      DSAError(
  ...
  "DSAResponse" should {
    "serialize to JSON with optional fields missing" in testJson(
      DSAResponse(Rid, Some(Closed)),
